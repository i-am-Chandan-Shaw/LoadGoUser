    ...
    <View style={style.container}>
      <View style={style.vehicleContainer}>
        ...
        <Vehicle
          ...
          discount={discount}
          onPress={() => {
            selectPickupVehicle('tataAce', amount.tataAce);
          }}
        ...
        <View style={style.paymentSection}>
          <View style={style.paymentOption}>
            <View style={style.amountContainer}>
              ...
              {offerApplied && (
                <Text style={style.fnt16Bold}>₹ {totalAmount - 300}</Text>
              )}
            </View>
      ...
      <View>
        ...
        <View style={style.pickupContainer}>
          ...
          <Text style={{color: '#000', fontSize: 14, fontWeight: 600}}>
            {' '}
            {receiverData.name} ({receiverData.phoneNo})
          </Text>
        </View>
      </View>
    </View>
